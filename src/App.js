...
const App = () => (
  <Layout>
    <div style={{ backgroundColor: '#001529', display: 'flex', padding: '20px', alignItems: 'center' }}>
      ...
      <Typography.Title level={2} style={{ color: 'white', margin: '0 0 0 15px' }}>CryptoOnTime</Typography.Title>
    </div>
    <Layout>
    ...
    <div style={{ backgroundColor: '#001529', display: 'flex', flexDirection: 'column', padding: '20px', alignItems: 'center' }}>
      <Typography.Title level={5} style={{ color: 'white' }}>Copyright © 2021 <Link to="/">CryptoOnTime Inc.</Link> All Rights Reserved.</Typography.Title>
      <Space>
        <Link to="/">Home</Link>
